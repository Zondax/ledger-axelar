...
[![GithubActions](https://github.com/zondax/ledger-axelar/actions/workflows/main.yml/badge.svg)](https://github.com/Zondax/ledger-axelar/blob/main/.github/workflows/main.yaml)
...
This project contains the Axelar app for Ledger Nano S and X.

- Ledger Nano S/X Axelar app
- Specs / Documentation
- C++ unit tests
- Zemu tests
...
Download a release from here (https://github.com/Zondax/ledger-axelar/releases). You only need `zxtool.sh`
