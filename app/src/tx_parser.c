...
static const key_subst_t value_substitutions[] = {
        {"axelar-sdk/MsgSend",                     "Send"},
        {"axelar-sdk/MsgDelegate",                 "Delegate"},
        {"axelar-sdk/MsgUndelegate",               "Undelegate"},
        {"axelar-sdk/MsgBeginRedelegate",          "Redelegate"},
        {"axelar-sdk/MsgSubmitProposal",           "Propose"},
        {"axelar-sdk/MsgDeposit",                  "Deposit"},
        {"axelar-sdk/MsgVote",                     "Vote"},
        {"axelar-sdk/MsgWithdrawDelegationReward", "Withdraw Reward"},
};
